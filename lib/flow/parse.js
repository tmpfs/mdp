...
module.exports = function parse(meta, markdown, callback) {
  ...
  var modifiers = [];
  if(meta.toc) {
    modifiers.push(middleware.toc(meta, toctok, meta.toc));
  }
  if(meta.base) modifiers.push(middleware.absolute(meta));
  if(meta.pedantic) modifiers.push(middleware.pedantic(meta));
