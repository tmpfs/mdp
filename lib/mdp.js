...
Readme.prototype.option = function() {
  this
    ...
    .option('-o, --output [file...]', 'Output file(s), default is README.md')
        ...
        concat.call(cli, meta, function(err, source) {
          ...
          tokenize.call(cli, meta, source, function(err, tokens) {
            ...
            async.mapSeries(list, function(format, callback) {
              ...
              build.call(cli, format, meta, tokens, function(err, document) {
              ...
              async.each(formats, function(item, callback) {
                ...
                async.each(item.files, function(file, callback) {
                  //console.dir(file);
                  //console.dir(format);
                  write.call(cli, file, item.document, function(err) {
                    callback(err);
                  });
                }, function(err) {
                  return callback(err);
