...
MarkdownProcessor.prototype.command = function() {}

MarkdownProcessor.prototype.option = function() {
  ...
  output += 'md, txt, html, xhtml or [1-8]. If no output files are specified ';
  ...
  this
    ...
    .option('--section [1-8]',
      'Set the man page section', cli.types.integer, 1)
    ...
    .option('--timeout [ms]', 'Timeout milliseconds for middleware',
      cli.types.integer, 10000)
...
module.exports = function(pkg) {
  ...
  return new MarkdownProcessor(pkg).load(file, def, function() {
    this.help('-h, --help')
      .version()
      .parse();
  });
