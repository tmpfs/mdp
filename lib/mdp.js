...
var CommandInterface = require('cli-interface').CommandInterface;
...
MarkdownProcessor.prototype.on = function() {
  this
    ...
    .on('complete', function(req) {
      ...
      if(debug) this.log.debug(JSON.stringify(req, undefined, 2));
      ...
      read.call(cli, files, function(err, meta) {
        ...
        //log.trace('%j', meta);
        if(debug) log.debug(JSON.stringify(meta, undefined, 2));
