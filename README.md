...
**Deprecated:** replaced by [mkdoc](https://github.com/mkdoc/mkdoc).
...
This document was generated with the following configuration (see [package.json](https://github.com/tmpfs/mdp/blob/master/package.json)):
...
Everything is [MIT](http://en.wikipedia.org/wiki/MIT_License). Read the [license](https://github.com/tmpfs/mdp/blob/master/LICENSE) if you feel inclined.

This program was built using the [command](https://github.com/cli-kit/cli-command) module, if you care for excellent documentation and write command line interfaces you should check it out.
